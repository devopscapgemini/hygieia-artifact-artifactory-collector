...
public class DefaultArtifactoryClientTest {
	...
	@Mock
	private ArtifactorySettings settings;
	@Mock
	...
	public void init() {
		...
		r.setPatterns(Arrays.asList(ArtifactUtilTest.IVY_PATTERN1, ArtifactUtilTest.IVY_ARTIFACT_PATTERN1,
				ArtifactUtilTest.MAVEN_PATTERN1, ArtifactUtilTest.ARTIFACT_PATTERN));
		...
		defaultArtifactoryClient = new DefaultArtifactoryClient(settings, new RestClient(restOperationsSupplier),
	...
	// Artifactory Pagination Helper: returns artifact items json with updated times
	...
	// Artifactory Pagination Helper: returns queried json string based on time
	// interval
	...
	private BinaryArtifact createMatchedExistingBinaryArtifact(ObjectId collectorItemId, String artifactName,
			String artifactVersion, String path, String repoName, boolean buildInfo) {
		BinaryArtifact b = new BinaryArtifact();
		b.setType("file");
		b.setCreatedTimeStamp(new Long("1539268036031"));
		b.setCreatedBy("auto");
